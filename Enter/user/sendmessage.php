					...
					$message =  "You have to click on one of the Doctors";
					 ...
					 require_once("library.php");
					  $dobbybb4 = new DataBase();
					   //connect to db
					  $dobbybb4->dbconnect();
					  $receiverId = $_POST['docIDs'];
					  $mess = $_POST['message'];
					  $fromType = "user";
					  $toType = "doctor";
					  $id = "$user_id";
					  $isSent = $dobbybb4->sendMessage($mess, $fromType, $toType, $id, $receiverId);
					  if($isSent == "Message Sent"){
  ...
  <div id="container">
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		...
		<br /><br /><br />
		  ...
		  <label for="nameOfDocs" class = "margin"><b> Select The Doctor to Message:  </b></label><br/><br/>
		<?php
		 require_once("library.php");
	 ...
	 echo "
		...
		?><br /><br />
          <label for="message">Message:<br />
            <textarea id="message" name="message" cols="60" rows="15" required></textarea>
          </label><br />
          <p>
            <input id="submitform" name="submitform" type="submit" value="Send" />
            &nbsp;
