...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">All Available Drugs</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
	  ...
	  $theSel = "select * from pharm where available = 'true'
	 ...
	 $fnamee = $gd['drugname'];	 
	  $id2 = $gd['id'] ;
		...
		<tr>
			...
			<td >&nbsp;&nbsp; $fnamee</td>
			<td>&nbsp;&nbsp;
			<form  action=\"edit_MA.php\" method=\"POST\" enctype=\"application/x-www-form-urlencoded\" 	name=\"del\">   
			    	<input type=\"submit\"   value=\"Set Unavailable\" />
